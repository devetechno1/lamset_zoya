...
class AppConfig {
  ...
  static const String app_name_ar = "Lamset Zoya";
  static const String app_name_en = "Lamset Zoya";
  ...
  static String default_country = "SA";

  //configure this
  static const bool HTTPS =
      true; //if you are using localhost , set this to false
  static const DOMAIN_PATH =
      "lamsetzoya.com"; //use only domain name without http:// or https://
